...
function ShowHideSettings({ title, subTitle, items }: Props) {
  ...
  return (
    <div>
      <div
        className="flex items-center py-5 px-5 gap-5 h-20 group cursor-pointer theme-bg theme-border"
      ...
      <div
        className="bg-slate-300/50 dark:bg-slate-700/50 space-y-2 grid transition-all duration-300 ease-in-out"
